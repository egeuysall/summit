						...
						<div className="space-y-6">
							<div className="flex items-center gap-4">
								<Avatar className="h-20 w-20">
									...
									<AvatarFallback className="text-h5">{getInitials(profile.name)}</AvatarFallback>
								</Avatar>
								<div>
									<h3 className="text-h5 font-semibold">{profile.name || 'Unknown User'}</h3>
									<p className="text-base text-neutral-500">{profile.credits || 0} credits</p>
								</div>
							</div>
