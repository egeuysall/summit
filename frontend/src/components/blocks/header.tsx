...
export const Header: React.FC = () => {
	 ...
	 */
	const menuItems = [
		{ id: 1, title: 'Tasks', link: '/dashboard/tasks' },
		{ id: 2, title: 'My Posted', link: '/dashboard/my-posted' },
		{ id: 3, title: 'My Claimed', link: '/dashboard/my-claimed' },
		{ id: 4, title: 'Leaderboard', link: '/dashboard/leaderboard' },
		{ id: 5, title: 'Profile', link: '/dashboard/profile' },
	];
			...
			<div className="w-full">
				<header className="backdrop-blur-lg py-xs px-md rounded-md flex justify-between items-center border border-neutral-300 dark:border-neutral-700">
					...
					<Link
						...
						className="flex gap-sm items-center flex-shrink-0 no-underline"
					>
						<Image
							width={iconSize}
							height={iconSize}
