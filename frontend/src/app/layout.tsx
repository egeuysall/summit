...
// TODO: Fill these
export const name = 'Summit: Work. Earn. Explore.';
...
export const description =
	'Join Summit, the gamified task marketplace where you earn credits, unlock interplanetary rewards, and compete with others. Complete tasks and rise beyond the stars!';

/**
 * The template string for dynamic page titles or metadata.
 * @type {string}
 */
const template = 'Summit';

/**
 * The base URL of the site.
 * @type {string}
 */
const siteUrl = 'http://www.summit.egeuysal.com';
...
const keywords: string[] = [
	'Summit',
	'task marketplace',
	'gamified work platform',
	'earn credits online',
	'skill sharing',
	'productivity app',
	'task rewards',
	'interplanetary rewards',
	'motivation platform',
	'competitive tasks',
	'gamification',
	'social task app',
 ...
 * @type {string}
 */
const imageDescription = 'Summit image';
